...
export const query = async (text: string, params?: unknown[]) => {
  try {
    ...
    if (text.includes("SELECT * FROM stores")) {
      ...
      text.includes("SELECT * FROM products WHERE is_featured = true")
    ) {
      return {
        rows: [
          {
            id: "1",
            title: "Classic Yankees Cap",
            price: 29.99,
            image: "/images/caps/yankees.jpg",
            storeName: "CapCity Store",
            isNew: false,
            isFeatured: true,
            isSoldOut: false,
          },
          {
            id: "2",
            title: "LA Dodgers Fitted",
            price: 34.99,
            image: "/images/caps/dodgers.jpg",
            storeName: "West Side Hats",
            isNew: true,
            isFeatured: true,
            isSoldOut: false,
          },
          {
            id: "3",
            title: "Chicago Cubs Limited Edition",
            price: 45.99,
            image: "/images/caps/cubs.jpg",
            storeName: "Midwest Cap Collection",
            isNew: true,
            isFeatured: true,
            isSoldOut: false,
          },
      ...
      return {
        rows: [
          ...
          {
            id: "4",
            title: "Boston Red Sox Cap",
            price: 32.99,
            image: "/images/caps/redsox.jpg",
          ...
          {
            id: "5",
            title: "Miami Marlins Snapback",
            price: 27.99,
            image: "/images/caps/marlins.jpg",
