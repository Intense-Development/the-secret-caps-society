...
import { Layers, Palette, Tag, ShoppingCart } from "lucide-react";
    ...
    <div className="space-y-5">
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          {product.isSoldOut && (
            <Badge variant="outline" className="text-red-500 border-red-200">Sold Out</Badge>
          )}
        </div>
      ...
      <div className="space-y-2 border-t pt-4">
        ...
        {selectedSize ? (
          <p className="text-sm text-muted-foreground mt-1">Selected size: {selectedSize}</p>
        ) : (
