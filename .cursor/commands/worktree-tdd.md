...
8- before committing and pushing, run @vercel-deployment-verifier to verify Vercel deployment readiness. If verification fails, fix the issues before proceeding
9- at the end after the confirmation of the user, commit the changes and push them to the branch
